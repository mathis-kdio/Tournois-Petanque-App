  ...
  _modalLanguages() {
    ...
    return (
      <Modal
        ...
        onClose={() => this.setState({ modalLanguagesOpen: false })}
      >
        <ModalBackdrop />
        <ModalContent className="max-h-5/6">
          ...
          <ModalBody>
            <Item
              text={t('francais')}
              action={() => this._changeLanguage('fr-FR')}
              icon={undefined}
              type="modal"
            ...
            <Item
              text={t('anglais')}
              action={() => this._changeLanguage('en-US')}
              icon={undefined}
              type="modal"
              drapeau={drapeauUSA}
            />
            ...
            <Item
              text={t('polonais')}
              action={() => this._changeLanguage('pl-PL')}
              icon={undefined}
              type="modal"
            ...
            <Item
              text={t('neerlandais')}
              action={() => this._changeLanguage('nl-NL')}
              icon={undefined}
              type="modal"
              ...
              <VStack>
                ...
                <Box className="border border-white rounded-lg">
                  <Item
                    ...
                    action={() => _openURL(this.githubRepository)}
                    icon="code"
                    type={undefined}
                    drapeau={undefined}
                  />
              ...
              <VStack>
                ...
                <Box className="border border-white rounded-lg">
                  <Item
                    ...
                    action={() => this.setState({ modalLanguagesOpen: true })}
                    icon="language"
                    type={undefined}
                    drapeau={undefined}
                  />
                  ...
                  <Item
                    ...
                    action={() => this.setState({ alertOpen: true })}
                    icon="trash-alt"
                    type="danger"
                    drapeau={undefined}
                  />
              ...
              <VStack>
                ...
                <Box className="border border-white rounded-lg">
                  <Item
                    ...
                    action={() => this.props.navigation.navigate('Changelog')}
                    icon="certificate"
                    type={undefined}
                    drapeau={undefined}
                  />
