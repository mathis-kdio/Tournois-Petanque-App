...
class Parametres extends React.Component<Props, State> {
  constructor(props: Props) {
    super(props)
    props.githubRepository = "https://github.com/sponsors/mathis-kdio";
    props.mail = "mailto:tournoispetanqueapp@gmail.com";
    props.crowdin = "https://crowdin.com/project/tournois-de-ptanque-gcu";
    this.state = {
      alertOpen: false,
      ...
      <Modal isOpen={this.state.modalLanguagesOpen} onClose={() => this.setState({modalLanguagesOpen: false})}>
        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            <Text textAlign='center' onPress={() => _openURL(this.props.crowdin)} color='$blue500'>{t("texte_lien_traduction")}</Text>
          ...
          <VStack flex={1} px={'$10'} space='lg'>
            <VStack>
              ...
              <Box borderWidth={'$1'} borderColor='$white' borderRadius={'$lg'}>
                {this._item(t("voir_source_code"), () => _openURL(this.props.githubRepository), "code", undefined, undefined)}
                <Divider/>
                {this._item("tournoispetanqueapp@gmail.com", () => _openURL(this.props.mail), "envelope", undefined, undefined)}
              </Box>
            </VStack>
            <VStack>
