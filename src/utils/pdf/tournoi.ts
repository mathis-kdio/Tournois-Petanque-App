...
export const generationPDFTournoi = (affichageScore: boolean, affichageClassement: boolean, listeJoueurs: Joueur[], listeMatchs: Match[], nbMatchsParTour: number, toursParLigne: number, nbToursRestants: number, nbTables: number) => {
