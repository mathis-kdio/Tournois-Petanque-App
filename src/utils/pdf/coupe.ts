...
export const generationPDFCoupe = (affichageScore: boolean, affichageClassement: boolean, listeJoueurs: Joueur[], optionsTournoi: OptionsTournoi, listeMatchs: Match[], nbMatchsParTour: number, toursParLigne: number, nbToursRestants: number, nbTables: number) => {
