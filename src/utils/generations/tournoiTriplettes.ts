...
export const generationTriplettes = (listeJoueurs, nbTours) => {
  ...
  */
  ...
  if (jamaisMemeCoequipier == true) {
    ...
    if (nbCombinaisons < nbTours) { //TODO: voir TODO au-dessus
    ...
    for (let j = 0; j < joueursNonSpe.length;) {
      ...
      //Affectation J2 E1
        ...
        if (jamaisMemeCoequipier == true && i > 0) {
          if (countOccuEquipe(joueurs[random[j]].equipe, matchs[idMatch].equipe[0][0]) < nbTours / 3) {
      ...
      //Affectation J3 E1
        ...
        //Ne s'applique qu'à partir de la manche 2
        if (jamaisMemeCoequipier == true && i > 0) {
          if (countOccuEquipe(joueurs[random[j]].equipe, matchs[idMatch].equipe[0][0]) < nbTours / 3 && countOccuEquipe(joueurs[random[j]].equipe, matchs[idMatch].equipe[0][1]) < nbTours / 3) {
      ...
      //Affectation J2 E2
        ...
        //Ne s'applique qu'à partir de la manche 2
        if (jamaisMemeCoequipier == true && i > 0) {
          if (countOccuEquipe(joueurs[random[j]].equipe, matchs[idMatch].equipe[1][0]) < nbTours / 3) {
      ...
      //Affectation J3 E2
        ...
        //Ne s'applique qu'à partir de la manche 2
        if (jamaisMemeCoequipier == true && i > 0) {
          if (countOccuEquipe(joueurs[random[j]].equipe, matchs[idMatch].equipe[1][0]) < nbTours / 3 && countOccuEquipe(joueurs[random[j]].equipe, matchs[idMatch].equipe[1][1]) < nbTours / 3) {
