      ...
      if (random[j] != undefined) {
        ...
        if (eviterMemeAdversaire !== 100) {
          if (matchs[idMatch].equipe[0][0] != -1) {
            ...
            const occurrencesAdversaireDansEquipe1 = (arr, joueurAdverse, joueurAffect) => arr.reduce((a, v) => ((v.equipe[0][0] === joueurAdverse) && (v.equipe[1][0] === joueurAffect) ? a + 1 : a), 0);
            const occurrencesAdversaireDansEquipe2 = (arr, joueurAdverse, joueurAffect) => arr.reduce((a, v) => ((v.equipe[1][0] === joueurAdverse) && (v.equipe[0][0] === joueurAffect) ? a + 1 : a), 0);
