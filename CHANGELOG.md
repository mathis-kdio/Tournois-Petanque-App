...
- Ajout de la rotation de l'application
- Ajout de la traduction espagnole
- Ajout de textes non traduits

### Changement

- Refonte du système de sauvegarde des données au sein de l'application
- Migration des données de l'ancien système vers le nouveau
- Modernisation de l'architecture technique de l'application

### Corrigé

- Correction de l'affichage de certains éléments
